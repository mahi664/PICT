...
//$email = $_Post['email'];
//echo $eid;
/*$sql = "SELECT eid,image,fullname,contact,acontact,texperience,iexperience,doj,department,designation,responsibility,aoi,other,cv FROM Faculty F WHERE F.email = '$email'";*/
...
<body> 
	...
	<div class="container-fluid" id="mainContent">
			...
			<div id="photo" class="card mycard">
				...
				<div class="card-footer" align="center">UPLOAD</div>
			</div>
