...
if(isset($_POST['picsubmit'])){
	...
	if (move_uploaded_file($_FILES["imageToUpload"]["tmp_name"], $target_file)) {
		...
		if($conn->query($query))
		{
        echo "<script>alert('Image successfully uploaded!! $dbpath');
        		window.location.href = '/PICT/facultyPage/editpage.php#personaltab';</script>";
        	}
    } else {
...
if(isset($_POST['ccvsubmit'])){
	...
	if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        echo "<script>alert('File successfully uploaded!! $target_file');
        		window.location.href = '/PICT/facultyPage/editpage.php#other';</script>";
    	}
    } else {
        echo "<script>alert('Error uploading file');
               window.location.href = '/PICT/facultyPage/editpage.php#other';</script> ";
...
if(isset($_POST['pdsubmit'])){
	...
	if($pdemail!=""){
		$sql = "INSERT INTO temp VALUES ('$eid','','0','email','faculty','$pdemail')";
		$query = $conn->query($sql);
		if($query){
			$change = 1;
		}
	...
	if($change == 1){
		...
		"<script>
			...
			window.location.href = '/PICT/facultyPage/editpage.php#qualifications'
		...
		"<script>
			...
			window.location.href = '/PICT/facultyPage/editpage.php#personaltab';
		</script>";
	}	
}
...
//Experience tab
 if(isset($_POST['exsubmit'])){
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');
			window.location.href = '/PICT/facultyPage/editpage.php#journals'
		</script>";
	}
	else{
		echo 
		"<script>
			alert('Request cannot be added!');
			window.location.href = '/PICT/facultyPage/editpage.php#experience';
		</script>";
	}	
 }
...
if(isset($_POST['odsubmit'])){
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php'
		</script>";
	}
	else{
		echo 
		"<script>
			alert('Request cannot be added!');		
			window.location.href = '/PICT/facultyPage/editpage.php#other';
		</script>";
	}	
}
...
$trowcnt = (int)$_SESSION['rowcntj'];
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php#books';
		</script>";
	}
	else{
		echo 
...
$trowcnt = (int)$_SESSION['rowcntb'];
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php#conference';
		</script>";
	}
	else{
		echo 
...
$trowcnt = (int)$_SESSION['rowcntc'];
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php#patents';
		</script>";
	}
	else{
		echo 
...
$trowcnt = (int)$_SESSION['rowcntpp'];
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php#consultancy';
		</script>";
	}
	else{
		echo 
...
//			$sql = 'INSERT INTO temp VALUES ("'.$eid.'","duration","Consultancy","'.$query1.'")';
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php#frp';
		</script>";
	}
	else{
		echo 
...
//			$sql = 'INSERT INTO temp VALUES ("'.$eid.'","remark","Fundedrp","'.$query1.'")';
	...
	if($change == 1){
		...
		"<script>
			alert('Request sent to admin');		
			window.location.href = '/PICT/facultyPage/editpage.php#CVupload';
		</script>";
	}
	else{
		echo 
