...
<head>
  ...
  <script type="text/javascript">
    function ftype(){
    var ft = document.getElementById("ft123").value;
    ...
    <br>
      ...
      <ul class="inner">
        <li><a  data-toggle="modal" href="#mfmodal">Add Faculty</a></li>
         <li><a href="dept_admin.php">Remove Faculty</a></li>
      </ul>
                     ...
                     <select name="dep" style="margin-left: 10px;">
                              ...
                              <br>
                                <label>Department</label>
                                 <select name="des" style="margin-left: 10px;">
                              ...
                              <label>Faculty Type<span style="color: red;"> *</span></label>
                                 <select name="level" class="myselect" onchange="ftype()" id="ft123">
                                  
                                  <option value="0">Regular</option>
                                  <option value="1">Adjunct</option>
...
if(isset($_POST['add']))
{
  ...
  $level = $_POST['level'];
  $date = $_POST['date'];
  $sql = "Insert into faculty (fullname,eid,contact,email,designation,department,enable,doj,adjunct,edate) values ('$in','$eno','$no','$mail','$designation','$department','$es','$date','$level','$edate')";
