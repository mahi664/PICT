...
<body> 
	...
	<div class="container-fluid" id="mainContent">
			...
			<!--<div id="photo" class="card mycard">
				<form action="uploadContent.php" method="post" enctype="multipart/form-data">
					...
					<div class="card-body" align="center">
						...
						<img src="/opt/lampp/htdocs/PICT/facultyPage/facultyImages/C2K.jpeg" alt="Faculty Photos" class="img-responsive" style="border-radius: 5px; width: 250px; height: 250px;">
						<input class="btn btn-info" type="file" accept="image/jpeg" name="imageToUpload" id="imageToUpload">
					</div>
					...
					<form action="uploadContent.php" method="post" onsubmit ="return checkeditpersonal()">
						...
						<div class="card-body" style=" padding: 0px;" align="center">
							<table style="margin-top: 10px; margin-bottom: 10px;">
								<tr>
									<td class="NameHeadings mytbstyle"></td>
									<td>
										<select name="mrmrs" disabled="" class="pdetails">
								...
								<tr>
									...
									<td>
										<input class="pdetails" type="email" name="pdemail" placeholder="" disabled>
									</td>
								</tr>
								<tr>
			...
			<div id="qualifications" class="card mycard">
				...
				<form action="uploadContent.php" method="post" onsubmit ="return checkeditqualifications()">
					...
					<div class="card-body">
						...
						<table class="table-striped table-bordered card-body" id="qualificationstable" style="width: 100%;">					
							<?php
			...
			echo'<tr>
				<td><input class="qdetails mytbstyle" type="text" name="qlevel[]" placeholder="'.$row1["level"].'" disabled>
				</td>
